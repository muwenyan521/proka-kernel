...
lazy_static! {
    pub static ref IDT: InterruptDescriptorTable = {
        ...
        idt.x87_floating_point.set_handler_fn(error_handler::x87_floating_point_handler);
        ...
        idt.cp_protection_exception.set_handler_fn(error_handler::control_protection_handler);


        // 特殊异常设置
        idt.page_fault.set_handler_fn(error_handler::pagefault_handler);
        idt.machine_check.set_handler_fn(error_handler::machine_check_handler);
